...
namespace UlmUniversityNews.Views.ModeratorViews.AddAndEditChannelDialog
{
    ...
    /// </summary>
    public sealed partial class AddAndEditChannel : Page
    {
        private NavigationHelper navigationHelper;
        private AddAndEditChannelViewModel addAndEditChannelViewModel;
        
        public AddAndEditChannel()
        {
            this.InitializeComponent();

            Windows.Phone.UI.Input.HardwareButtons.BackPressed += HardwareButtons_BackPressed;
            this.Unloaded += AddAndEditChannel_Unloaded;

            this.navigationHelper = new NavigationHelper(this);
            this.navigationHelper.LoadState += this.NavigationHelper_LoadState;
            this.navigationHelper.SaveState += this.NavigationHelper_SaveState;

            addAndEditChannelViewModel = new AddAndEditChannelViewModel(App.NavigationService, App.ErrorMapper);
            this.DataContext = addAndEditChannelViewModel;

            // Initialisierung Drawer Menü.
            DrawerLayout.InitializeDrawerLayout();
            ListMenuItems.ItemsSource = addAndEditChannelViewModel.LoadDrawerMenuEntries();
        }
        ...
        void HardwareButtons_BackPressed(object sender, Windows.Phone.UI.Input.BackPressedEventArgs e)
        {
            ...
            addAndEditChannelViewModel.ShowWarningFlyout.Execute(drawerMenuEntry);
        }
        ...
        /// <param name="e"></param>
        void AddAndEditChannel_Unloaded(object sender, RoutedEventArgs e)
        {
            Windows.Phone.UI.Input.HardwareButtons.BackPressed -= HardwareButtons_BackPressed;
        }
    }
