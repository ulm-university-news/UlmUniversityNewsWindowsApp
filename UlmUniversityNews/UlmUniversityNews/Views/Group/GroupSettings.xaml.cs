...
namespace UlmUniversityNews.Views.Group
{
    ...
    /// </summary>
    public sealed partial class GroupSettings : Page
    {
        private NavigationHelper navigationHelper;

        /// <summary>
        /// Eine Referenz auf die ViewModel Instanz, die dieser View zugeordnet ist.
        /// </summary>
        private GroupSettingsViewModel groupSettingsViewModel;
        ...
        public GroupSettings()
        {
            ...
            groupSettingsViewModel = new GroupSettingsViewModel(App.NavigationService, App.ErrorMapper);
            this.DataContext = groupSettingsViewModel;

            // Initialisiere das Drawer Layout.
            DrawerLayout.InitializeDrawerLayout();
            ListMenuItems.ItemsSource = groupSettingsViewModel.LoadDrawerMenuEntries();
        }
