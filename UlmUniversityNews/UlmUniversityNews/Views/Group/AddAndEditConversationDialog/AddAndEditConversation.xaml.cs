...
namespace UlmUniversityNews.Views.Group.AddAndEditConversationDialog
{
    /// <summary>
    /// Eine leere Seite, die eigenständig verwendet werden kann oder auf die innerhalb eines Frames navigiert werden kann.
    /// </summary>
    public sealed partial class AddAndEditConversation : Page
    {
        private NavigationHelper navigationHelper;

        /// <summary>
        /// Eine Referenz auf eine Instanz der ViewModel Klasse, die dieser View zugeordnet ist.
        /// </summary>
        private AddAndEditConversationViewModel addAndEditConversationViewModel;

        public AddAndEditConversation()
        {
            ...
            addAndEditConversationViewModel = new AddAndEditConversationViewModel(App.NavigationService, App.ErrorMapper);
            this.DataContext = addAndEditConversationViewModel;

            // Initialisiere das Drawer Layout.
            DrawerLayout.InitializeDrawerLayout();
            ListMenuItems.ItemsSource = addAndEditConversationViewModel.LoadDrawerMenuEntries();
        }
        ...
        void HardwareButtons_BackPressed(object sender, Windows.Phone.UI.Input.BackPressedEventArgs e)
        {
            ...
            addAndEditConversationViewModel.ShowWarningFlyout.Execute(drawerMenuEntry);
        }
